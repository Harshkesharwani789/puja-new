  ...
  const categories = [
    {
      title: "Idols & Statues",
      image:
        "https://media.istockphoto.com/id/522247569/photo/golden-leaf-buddha.webp?a=1&b=1&s=612x612&w=0&k=20&c=Rh0gTP1zSHTbK0aQWpDsAGlqsjkM7ShKiQrXaVnFl-U=",
      ...
      >
        {categories.map((category, index) => (
          <Link
            key={index}
            href={category.href}
            className="group flex-shrink-0 w-[180px] md:w-[220px] snap-start"
          >
