...
import { ShoppingCart, Heart, Search, Menu, X, ArrowRight, ChevronRight } from "lucide-react"
      ...
      <main className="container py-8">
        ...
        <div className="my-6 bg-primary/10 rounded-lg p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm md:text-base">Diwali Special Collection is now available! Limited stock.</p>
          </div>
        ...
        <section className="my-12 py-10 px-6 bg-primary/5 rounded-lg">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Limited time deals on premium puja items</p>
          </div>
        ...
        <section className="my-12">
          <h2 className="text-2xl font-bold mb-6 text-center">Featured Collections</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="group relative overflow-hidden rounded-lg border hover:shadow-md transition-shadow">
              ...
              <div className="relative p-6 md:p-8 flex flex-col h-full min-h-[300px] justify-end">
                <h3 className="text-2xl font-bold text-white mb-2">Diwali Collection</h3>
                <p className="text-white/90 mb-4">Illuminate your celebrations with our exclusive Diwali collection</p>
            ...
            <div className="group relative overflow-hidden rounded-lg border hover:shadow-md transition-shadow">
              ...
              <div className="relative p-6 md:p-8 flex flex-col h-full min-h-[300px] justify-end">
                <h3 className="text-2xl font-bold text-white mb-2">Premium Idols</h3>
                <p className="text-white/90 mb-4">Exquisitely crafted idols for your home temple</p>
                <Button asChild className="w-fit" variant="secondary">
        ...
        <section className="my-12 overflow-hidden">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Our most popular products this season</p>
          </div>

          <div className="animate-marquee flex gap-6">
            {Array.from({ length: 8 }).map((_, index) => (
              <div key={index} className="min-w-[250px] max-w-[250px] border rounded-lg p-4 flex flex-col">
                ...
                <h3 className="font-medium line-clamp-1">Trending Product {index + 1}</h3>
                <p className="text-sm text-muted-foreground mb-2">Category</p>
                <div className="mt-auto">
                  <p className="font-semibold">₹{(Math.floor(Math.random() * 2000) + 500).toLocaleString()}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="my-12 py-10 px-6 bg-primary/5 rounded-lg">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Trusted by devotees across the country</p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm">Your one-stop shop for all puja essentials and spiritual products.</p>
